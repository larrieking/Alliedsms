...
import com.mycompany.wordify.util.JsfUtil;
import com.mycompany.wordify.util.PaginationHelper;
...
public class UsersController implements Serializable {
    ...
    @EJB
    private com.mycompany.wordify.UsersFacade ejbFacade;
    ...
    public Users getSelected() {
        if (current == null) {
            current = new Users();
            current.setUsersPK(new com.mycompany.wordify.UsersPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public Users getUsers(com.mycompany.wordify.UsersPK id) {
    ...
    public static class UsersControllerConverter implements Converter {
        ...
        com.mycompany.wordify.UsersPK getKey(String value) {
            com.mycompany.wordify.UsersPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.mycompany.wordify.UsersPK();
            key.setId(Integer.parseInt(values[0]));
            key.setEmail(values[1]);
            return key;
        }

        String getStringKey(com.mycompany.wordify.UsersPK value) {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Users) {
                ...
                return getStringKey(o.getUsersPK());
            } else {
